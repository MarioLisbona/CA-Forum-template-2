	...
	return (
		<>
          ...
          <div class="container-fluid">
              <a class="navbar-brand text-white" href="./final-template.html">Traveler's Forum</a>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                      <li class="nav-item active">
                          <a class="nav-link text-success-emphasis" href="./final-template.html">Home</a>
                      </li>
                      <li class="nav-item">
                          <a class="nav-link text-white" href="./final-template copy.html">Browse all Destinations</a>
                      </li>
                      <li class="nav-item dropdown">
                          ...
                          <a class="dropdown-item text-white" href="./final-template-Australia.html">Australia</a>
                          </div>
                      </li>
                      <li class="nav-item">
